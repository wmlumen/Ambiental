      ...
      <body className="min-h-screen flex flex-col">
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-moss-100">
          <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
            <a href="/Ambiental/" className="flex items-center gap-3">
            ...
            <nav className="flex items-center gap-1 md:gap-2">
              <a href="/Ambiental/" className="btn-ghost text-sm">Inicio</a>
              <a href="/Ambiental/cursos" className="btn-ghost text-sm">Cursos</a>
              <a href="/Ambiental/mapa-web" className="btn-ghost text-sm">Mapa</a>
              <a href="/Ambiental/arquitectura" className="btn-ghost text-sm">Arquitectura</a>
            </nav>
          </div>
        </header>
