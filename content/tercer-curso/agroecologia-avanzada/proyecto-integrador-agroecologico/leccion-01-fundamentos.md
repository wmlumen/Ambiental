---
title: "Unidad 5 | Proyecto integrador agroecológico | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 5 | Proyecto integrador agroecológico"
unitDescription: "diseño, implementación y evaluación"
unitOrder: 5
lessonOrder: 1
topics:
  - proyecto
...
# Unidad 5 | Proyecto integrador agroecológico | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de diseño, implementación y evaluación.
...
En **Agroecología Avanzada**, esta microlección aborda **diseño, implementación y evaluación** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **diseño, implementación y evaluación** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione diseño, implementación y evaluación con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre diseño, implementación y evaluación en Paraguay.
...
- **proyecto, integrador, evaluación.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **proyecto, integrador, evaluación.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- diseño, implementación y evaluación se estudia con relación al territorio y a la vida comunitaria.
