---
title: "Unidad 1 | Diseño de fincas agroecológicas | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Diseño de fincas agroecológicas"
unitDescription: "zonificación, integración y flujos"
unitOrder: 1
lessonOrder: 1
topics:
  - diseño
...
# Unidad 1 | Diseño de fincas agroecológicas | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de zonificación, integración y flujos.
...
En **Agroecología Avanzada**, esta microlección aborda **zonificación, integración y flujos** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **zonificación, integración y flujos** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione zonificación, integración y flujos con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre zonificación, integración y flujos en Paraguay.
...
- **diseño, finca, integración.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **diseño, finca, integración.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- zonificación, integración y flujos se estudia con relación al territorio y a la vida comunitaria.
