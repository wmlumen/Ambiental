---
title: "Unidad 4 | Participación pública en la EIA | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 4 | Participación pública en la EIA"
unitDescription: "consulta, audiencias y comunicación"
unitOrder: 4
lessonOrder: 1
topics:
  - participación
...
# Unidad 4 | Participación pública en la EIA | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de consulta, audiencias y comunicación.
...
En **Evaluación de Impacto Ambiental**, esta microlección aborda **consulta, audiencias y comunicación** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **consulta, audiencias y comunicación** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione consulta, audiencias y comunicación con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Evaluación de Impacto Ambiental.
- 🎥 **Video:** Investiga en internet documentales breves sobre consulta, audiencias y comunicación en Paraguay.
...
- **participación, consulta, audiencias.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **participación, consulta, audiencias.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- consulta, audiencias y comunicación se estudia con relación al territorio y a la vida comunitaria.
