---
title: "Unidad 3 | Medidas de mitigación y compensación | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 3 | Medidas de mitigación y compensación"
unitDescription: "jerarquía de mitigación y planes de manejo"
unitOrder: 3
lessonOrder: 1
topics:
  - mitigación
...
# Unidad 3 | Medidas de mitigación y compensación | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de jerarquía de mitigación y planes de manejo.
...
En **Evaluación de Impacto Ambiental**, esta microlección aborda **jerarquía de mitigación y planes de manejo** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **jerarquía de mitigación y planes de manejo** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione jerarquía de mitigación y planes de manejo con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre jerarquía de mitigación y planes de manejo en Paraguay.
...
- jerarquía de mitigación y planes de manejo se estudia con relación al territorio y a la vida comunitaria.
