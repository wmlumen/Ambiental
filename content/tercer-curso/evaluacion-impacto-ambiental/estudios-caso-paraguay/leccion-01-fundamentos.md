---
title: "Unidad 5 | Estudios de caso en Paraguay | Lección 1 | Fundamentos"
...
unitDescription: "análisis de EIA reales del país"
unitOrder: 5
lessonOrder: 1
topics:
  - Paraguay
...
# Unidad 5 | Estudios de caso en Paraguay | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de análisis de EIA reales del país.
...
En **Evaluación de Impacto Ambiental**, esta microlección aborda **análisis de EIA reales del país** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **análisis de EIA reales del país** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione análisis de EIA reales del país con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre análisis de EIA reales del país en Paraguay.
...
- **Paraguay, casos, EIA reales.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **Paraguay, casos, EIA reales.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- análisis de EIA reales del país se estudia con relación al territorio y a la vida comunitaria.
