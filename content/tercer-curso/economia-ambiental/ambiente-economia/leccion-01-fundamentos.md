---
title: "Unidad 1 | Ambiente y economía | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Ambiente y economía"
unitDescription: "relación entre recursos y decisiones"
unitOrder: 1
lessonOrder: 1
topics:
  - ambiente
...
# Unidad 1 | Ambiente y economía | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de relación entre recursos y decisiones.
...
En **Economía Ambiental**, esta microlección aborda **relación entre recursos y decisiones** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **relación entre recursos y decisiones** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione relación entre recursos y decisiones con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre relación entre recursos y decisiones en Paraguay.
...
- **ambiente, economía, recursos.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **ambiente, economía, recursos.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- relación entre recursos y decisiones se estudia con relación al territorio y a la vida comunitaria.
