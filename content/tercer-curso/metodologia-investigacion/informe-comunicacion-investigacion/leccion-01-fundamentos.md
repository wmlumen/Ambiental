---
title: "Unidad 5 | Informe y comunicación de resultados | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 5 | Informe y comunicación de resultados"
unitDescription: "presentación de hallazgos"
unitOrder: 5
lessonOrder: 1
topics:
  - informe
...
# Unidad 5 | Informe y comunicación de resultados | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de presentación de hallazgos.
...
En **Metodología de la Investigación**, esta microlección aborda **presentación de hallazgos** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **presentación de hallazgos** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione presentación de hallazgos con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre presentación de hallazgos en Paraguay.
...
- **informe, comunicación, resultados.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **informe, comunicación, resultados.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- presentación de hallazgos se estudia con relación al territorio y a la vida comunitaria.
