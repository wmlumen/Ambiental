---
title: "Unidad 1 | Problema y pregunta de investigación | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Problema y pregunta de investigación"
unitDescription: "cómo iniciar un estudio del entorno"
unitOrder: 1
lessonOrder: 1
topics:
  - problema
...
# Unidad 1 | Problema y pregunta de investigación | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de cómo iniciar un estudio del entorno.
...
En **Metodología de la Investigación**, esta microlección aborda **cómo iniciar un estudio del entorno** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **cómo iniciar un estudio del entorno** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione cómo iniciar un estudio del entorno con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Metodología de la Investigación.
- 🎥 **Video:** Investiga en internet documentales breves sobre cómo iniciar un estudio del entorno en Paraguay.
...
- **problema, pregunta, investigación.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **problema, pregunta, investigación.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- cómo iniciar un estudio del entorno se estudia con relación al territorio y a la vida comunitaria.
