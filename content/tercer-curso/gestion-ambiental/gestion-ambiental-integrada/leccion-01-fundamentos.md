---
title: "Unidad 1 | Gestión ambiental integrada | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Gestión ambiental integrada"
unitDescription: "enfoque sistémico, actores y escalas"
unitOrder: 1
lessonOrder: 1
topics:
  - gestión
...
# Unidad 1 | Gestión ambiental integrada | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de enfoque sistémico, actores y escalas.
...
En **Gestión Ambiental**, esta microlección aborda **enfoque sistémico, actores y escalas** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **enfoque sistémico, actores y escalas** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione enfoque sistémico, actores y escalas con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre enfoque sistémico, actores y escalas en Paraguay.
...
- **gestión, sistema, actores.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **gestión, sistema, actores.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- enfoque sistémico, actores y escalas se estudia con relación al territorio y a la vida comunitaria.
