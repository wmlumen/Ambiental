---
title: "Unidad 1 | Formulación del proyecto | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Formulación del proyecto"
unitDescription: "problema, objetivos y marco lógico"
unitOrder: 1
lessonOrder: 1
topics:
  - formulación
...
# Unidad 1 | Formulación del proyecto | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de problema, objetivos y marco lógico.
...
En **Proyecto Ambiental Integrador**, esta microlección aborda **problema, objetivos y marco lógico** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **problema, objetivos y marco lógico** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione problema, objetivos y marco lógico con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre problema, objetivos y marco lógico en Paraguay.
...
- problema, objetivos y marco lógico se estudia con relación al territorio y a la vida comunitaria.
