---
title: "Unidad 3 | Ejecución y monitoreo | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 3 | Ejecución y monitoreo"
unitDescription: "implementación, registro de avances y ajustes"
unitOrder: 3
lessonOrder: 1
topics:
  - ejecución
...
# Unidad 3 | Ejecución y monitoreo | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de implementación, registro de avances y ajustes.
...
En **Proyecto Ambiental Integrador**, esta microlección aborda **implementación, registro de avances y ajustes** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **implementación, registro de avances y ajustes** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione implementación, registro de avances y ajustes con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre implementación, registro de avances y ajustes en Paraguay.
...
- implementación, registro de avances y ajustes se estudia con relación al territorio y a la vida comunitaria.
