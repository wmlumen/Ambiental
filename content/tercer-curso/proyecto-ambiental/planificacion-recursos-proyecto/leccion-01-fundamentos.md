---
title: "Unidad 2 | Planificación de recursos | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 2 | Planificación de recursos"
...
# Unidad 2 | Planificación de recursos | Lección 1 | Fundamentos
...
En **Proyecto Ambiental Integrador**, esta microlección aborda **presupuesto, cronograma y equipo** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **presupuesto, cronograma y equipo** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione presupuesto, cronograma y equipo con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Proyecto Ambiental Integrador.
- 🎥 **Video:** Investiga en internet documentales breves sobre presupuesto, cronograma y equipo en Paraguay.
...
- **recursos, presupuesto, cronograma.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **recursos, presupuesto, cronograma.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- presupuesto, cronograma y equipo se estudia con relación al territorio y a la vida comunitaria.
