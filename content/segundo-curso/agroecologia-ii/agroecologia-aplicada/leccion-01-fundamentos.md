---
title: "Unidad 1 | Agroecología aplicada | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Agroecología aplicada"
unitDescription: "del principio a la práctica productiva"
unitOrder: 1
lessonOrder: 1
topics:
  - agroecología
...
# Unidad 1 | Agroecología aplicada | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de del principio a la práctica productiva.
...
En **Agroecología II**, esta microlección aborda **del principio a la práctica productiva** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **del principio a la práctica productiva** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione del principio a la práctica productiva con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Agroecología II.
- 🎥 **Video:** Investiga en internet documentales breves sobre del principio a la práctica productiva en Paraguay.
...
- **agroecología, práctica, producción.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **agroecología, práctica, producción.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- del principio a la práctica productiva se estudia con relación al territorio y a la vida comunitaria.
