---
title: "Unidad 2 | Pronóstico del tiempo | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 2 | Pronóstico del tiempo"
unitDescription: "modelos, mapas sinópticos e interpretación"
unitOrder: 2
lessonOrder: 1
topics:
  - pronóstico
...
# Unidad 2 | Pronóstico del tiempo | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de modelos, mapas sinópticos e interpretación.
...
En **Meteorología Aplicada**, esta microlección aborda **modelos, mapas sinópticos e interpretación** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **modelos, mapas sinópticos e interpretación** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione modelos, mapas sinópticos e interpretación con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre modelos, mapas sinópticos e interpretación en Paraguay.
...
- modelos, mapas sinópticos e interpretación se estudia con relación al territorio y a la vida comunitaria.
