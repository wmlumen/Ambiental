---
title: "Unidad 1 | Sociedad, territorio y ambiente | Lección 1 | Fundamentos"
...
unitDescription: "relaciones básicas entre comunidad y espacio"
unitOrder: 1
lessonOrder: 1
topics:
  - sociedad
...
# Unidad 1 | Sociedad, territorio y ambiente | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de relaciones básicas entre comunidad y espacio.
...
En **Sociología Rural y Urbana**, esta microlección aborda **relaciones básicas entre comunidad y espacio** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **relaciones básicas entre comunidad y espacio** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione relaciones básicas entre comunidad y espacio con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Sociología Rural y Urbana.
- 🎥 **Video:** Investiga en internet documentales breves sobre relaciones básicas entre comunidad y espacio en Paraguay.
...
- **sociedad, territorio, ambiente.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **sociedad, territorio, ambiente.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- relaciones básicas entre comunidad y espacio se estudia con relación al territorio y a la vida comunitaria.
