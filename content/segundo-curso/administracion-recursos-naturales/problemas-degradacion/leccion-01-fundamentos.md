---
title: "Unidad 4 | Problemas de degradación | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 4 | Problemas de degradación"
unitDescription: "sobreexplotación, erosión y pérdida de cobertura"
unitOrder: 4
lessonOrder: 1
topics:
  - degradación
...
# Unidad 4 | Problemas de degradación | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de sobreexplotación, erosión y pérdida de cobertura.
...
En **Administración de los Recursos Naturales**, esta microlección aborda **sobreexplotación, erosión y pérdida de cobertura** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
En **San Pedro**, las comunidades cercanas al río Paraguay integran este conocimiento en sus prácticas cotidianas. En escuelas agrícolas de **Guairá**, docentes y estudiantes aplican estos conceptos en huertas demostrativas y proyectos de extensión.
...
Realiza una investigación breve sobre **sobreexplotación, erosión y pérdida de cobertura** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione sobreexplotación, erosión y pérdida de cobertura con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre sobreexplotación, erosión y pérdida de cobertura en Paraguay.
...
- **degradación, erosión, sobreexplotación.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **degradación, erosión, sobreexplotación.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- sobreexplotación, erosión y pérdida de cobertura se estudia con relación al territorio y a la vida comunitaria.
- La unidad fortalece la comprensión, la organización y la aplicación del contenido.
- El contexto paraguayo ofrece ejemplos concretos en departamentos como San Pedro y Guairá.
