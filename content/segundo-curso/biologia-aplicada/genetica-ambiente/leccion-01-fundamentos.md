---
title: "Unidad 2 | Genética y ambiente | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 2 | Genética y ambiente"
unitDescription: "herencia, variabilidad y adaptación"
unitOrder: 2
lessonOrder: 1
topics:
  - genética
...
# Unidad 2 | Genética y ambiente | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de herencia, variabilidad y adaptación.
...
En **Biología Aplicada**, esta microlección aborda **herencia, variabilidad y adaptación** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **herencia, variabilidad y adaptación** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione herencia, variabilidad y adaptación con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre herencia, variabilidad y adaptación en Paraguay.
...
- herencia, variabilidad y adaptación se estudia con relación al territorio y a la vida comunitaria.
