---
title: "Unidad 5 | Evaluación y mejora continua | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 5 | Evaluación y mejora continua"
...
# Unidad 5 | Evaluación y mejora continua | Lección 1 | Fundamentos
...
En **Administración Ambiental**, esta microlección aborda **resultados, ajustes y lecciones aprendidas** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **resultados, ajustes y lecciones aprendidas** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione resultados, ajustes y lecciones aprendidas con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Administración Ambiental.
- 🎥 **Video:** Investiga en internet documentales breves sobre resultados, ajustes y lecciones aprendidas en Paraguay.
...
- **evaluación, mejora, resultados.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **evaluación, mejora, resultados.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- resultados, ajustes y lecciones aprendidas se estudia con relación al territorio y a la vida comunitaria.
