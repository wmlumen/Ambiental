---
title: "Unidad 1 | Administración y ambiente | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Administración y ambiente"
unitDescription: "conceptos básicos de gestión ambiental"
unitOrder: 1
lessonOrder: 1
topics:
  - administración
...
# Unidad 1 | Administración y ambiente | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de conceptos básicos de gestión ambiental.
...
En **Administración Ambiental**, esta microlección aborda **conceptos básicos de gestión ambiental** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **conceptos básicos de gestión ambiental** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione conceptos básicos de gestión ambiental con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre conceptos básicos de gestión ambiental en Paraguay.
...
- **administración, gestión, ambiente.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **administración, gestión, ambiente.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- conceptos básicos de gestión ambiental se estudia con relación al territorio y a la vida comunitaria.
