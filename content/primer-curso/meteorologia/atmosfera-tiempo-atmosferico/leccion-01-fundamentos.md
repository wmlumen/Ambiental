---
title: "Unidad 1 | Atmósfera y tiempo atmosférico | Lección 1 | Fundamentos"
description: "Microlección inicial centrada en conceptos base, objetivos y comprensión del tema."
unitTitle: "Unidad 1 | Atmósfera y tiempo atmosférico"
unitDescription: "capas, composición y dinámica"
unitOrder: 1
lessonOrder: 1
topics:
  - atmósfera
...
# Unidad 1 | Atmósfera y tiempo atmosférico | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de capas, composición y dinámica.
...
En **Meteorología**, esta microlección aborda **capas, composición y dinámica** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **capas, composición y dinámica** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione capas, composición y dinámica con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 🎥 **Video:** Investiga en internet documentales breves sobre capas, composición y dinámica en Paraguay.
...
- **atmósfera, tiempo, dinámica.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **atmósfera, tiempo, dinámica.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- capas, composición y dinámica se estudia con relación al territorio y a la vida comunitaria.
