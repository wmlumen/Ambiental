---
title: "Unidad 2 | Elementos del clima | Lección 1 | Fundamentos"
...
unitDescription: "temperatura, precipitación, viento y humedad"
unitOrder: 2
lessonOrder: 1
topics:
  - temperatura
...
# Unidad 2 | Elementos del clima | Lección 1 | Fundamentos

## Objetivos de aprendizaje

- Comprender las ideas centrales de temperatura, precipitación, viento y humedad.
...
En **Meteorología**, esta microlección aborda **temperatura, precipitación, viento y humedad** como parte del recorrido formativo de la unidad. Se trabaja con ejemplos concretos del Paraguay, situaciones escolares reales y problemas ambientales del entorno inmediato.
...
Realiza una investigación breve sobre **temperatura, precipitación, viento y humedad** en tu comunidad. Documenta con fotos, entrevistas cortas (2-3 personas) y un registro escrito de observaciones.

### Actividad grupal
En equipos de 3-4 estudiantes, elaboren un **mapa conceptual colaborativo** que relacione temperatura, precipitación, viento y humedad con al menos tres situaciones reales de su entorno. Preséntenlo en 5 minutos al curso.
...
- 📖 **Lectura:** Busca en la biblioteca escolar materiales del MEC relacionados con Meteorología.
- 🎥 **Video:** Investiga en internet documentales breves sobre temperatura, precipitación, viento y humedad en Paraguay.
...
- **temperatura, precipitación, viento.Split(',')[0].Trim()**: concepto fundamental de esta unidad que se relaciona directamente con el entorno.
- **temperatura, precipitación, viento.Split(',')[-1].Trim()**: noción complementaria que amplía la comprensión del tema.

## Resumen

- temperatura, precipitación, viento y humedad se estudia con relación al territorio y a la vida comunitaria.
